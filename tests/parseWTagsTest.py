...
class ParseWTagsTestCase(unittest.TestCase):
    ...
    def test_parse_lists_to_wtag_file_with_one_sentence(self):
        ...
        with open(output_one_sentence_file_name) as f:
            file1_data = f.read()
        expected_output_one_sentence_file_name = "trialDataFiles/expectedOutputTrialOneSentence.wtag"
        with open(expected_output_one_sentence_file_name) as f:
            file2_data = f.read()
    ...
    def test_parse_lists_to_wtag_file_with_two_sentences(self):
        ...
        with open(output_two_sentences_file_name) as f:
            file1_data = f.read()
        expected_output_two_sentences_file_name = "trialDataFiles/expectedOutputTrialTwoSentences.wtag"
        with open(expected_output_two_sentences_file_name) as f:
            file2_data = f.read()
        self.assertEqual(file1_data, file2_data)

    def test_parse_lists_to_wtag_file_with_all_sentences(self):
        all_sentences_file_name = "../data/train.wtag"
